...
!!! note
    計算ノード(V)と、計算ノード(A)ではOSおよびソフトウェア構成が異なるため、計算ノード(V)で構築した仮想環境は計算ノード(A)で使用できない可能性が高いです。また、同様に計算ノード(A)で構築した仮想環境は、計算ノード(V)で使用できない可能性が高いです。<br>
    そのため、計算ノード(V)で使用する仮想環境は計算ノード(V)(またはインタラクティブノード(es))で構築いただき、計算ノード(A)で使用する環境は計算ノード(A)(またはインタラクティブノード(es-a))で構築いただく必要があります。
