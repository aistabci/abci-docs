...
ABCIクラウドストレージでは、使用量(データ占有量)に基づいて、オブジェクトの作成者(クラウドストレージアカウント)が所属するABCIグループに課金されます。消費されるポイントについては[料金表](https://abci.ai/ja/how_to_use/tariffs.html)をご確認ください。

!!! note
    お試し利用期間の間は、利用料金はかかりません。
