...
ABCIシステムでは、2種類の計算ノード(計算ノード(V), 計算ノード(A)) がありますが、各計算ノード向けプログラム開発の利便性を向上させるために、インタラクティブノードについてもインタラクティブノード(V),インタラクティブノード(A)の2種類提供されています。 計算ノード(V)向けアプリケーションのプログラム開発はインタラクティブノード(V)で行い、計算ノード(A)向けアプリケーションのプログラム開発はインタラクティブノード(A)で行います。
なお、インタラクティブノード(V)から計算ノード(A)に、インタラクティブノード(A)から計算ノード(V)に、相互にジョブを投入することが可能です。
...
| 項目 | 説明 | 個数 |
|:--|:--|:--|
| CPU | [Intel Xeon Platinum 8360Yプロセッサー 2.4 GHz, 36 Cores (72 Threads)](https://ark.intel.com/content/www/us/en/ark/products/212459/intel-xeon-platinum-8360y-processor-54m-cache-2-40-ghz.html) | 2 |
...
| 計算ノード(V) | /local | 1.6 TB | XFS | [ローカルストレージ](04.md#local-storage)を参照 |
| 計算ノード(A) | /local1 | 2.0 TB | XFS | [ローカルストレージ](04.md#local-storage)を参照 |
|               | /local2 | 2.0 TB | XFS | [ローカルストレージ](04.md#local-storage)を参照 |
...
| Library | [cuDNN](07.md#cudnn) | 5.1.10<br>6.0.21<br>7.0.5<br>7.1.4<br>7.2.1<br>7.3.1<br>7.4.2<br>7.5.1<br>7.6.5<br>8.0.5<br>8.1.1 | 7.3.1<br>7.4.2<br>7.5.1<br>7.6.5<br>8.0.5<br>8.1.1 |
| | [NCCL](07.md#nccl) | 1.3.5-1<br>2.1.15-1<br>2.2.13-1<br>2.3.7-1<br>2.4.8-1<br>2.5.6-1<br>2.6.4-1<br>2.7.8-1<br>2.8.4-1 | 2.3.7-1<br>2.4.8-1<br>2.5.6-1<br>2.6.4-1<br>2.7.8-1<br>2.8.4-1 |
| | gdrcopy | 2.0 | 2.1 |
| | UCX | 1.7.0 | 1.9.0 |
