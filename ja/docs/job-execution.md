...
|:--|:--|:--|:--|:--|:--|:--|:--|
| Full | rt\_F | ノード占有 | 40 | 4 | 360 | 1440 | 1.20 |
| G.large | rt\_G.large | ノード共有<br>GPU利用 | 20 | 4 | 240 | 720 | 1.08 |
| G.small | rt\_G.small | ノード共有<br>GPU利用 | 5 | 1 | 60 | 180 | 0.36 |
| C.large | rt\_C.large | ノード共有<br>CPUのみ利用 | 20 | 0 | 120 | 720 | 0.72 |
| C.small | rt\_C.small | ノード共有<br>CPUのみ利用 | 5 | 0 | 30 | 180 | 0.24 |

#### 計算ノード(A) {#compute-node-a}

| 資源タイプ | 資源タイプ名 | 説明 | 割り当て物理CPUコア数 | 割り当てGPU数 | メモリ (GiB) | ローカルストレージ (GB) | 資源タイプ課金係数 |
|:--|:--|:--|:--|:--|:--|:--|:--|
| Full | rt\_AF | ノード占有 | 72 | 8 | 480 | 3440[^1] | 6.00 |
| AG.small | rt\_AG.small | ノード共有<br>GPU利用 | 9 | 1 | 60 | 390 | 1.00 |
