...
|:--|:--|:--|:--|:--|:--|:--|
| rt\_HF | ノード占有 | 96 | 8 | 1920 | 14 | 7.5 |
| rt\_HG | ノード共有<br>GPU利用 | 8 | 1 | 160 | 1.4 | 1.5 |
| rt\_HC | ノード共有<br>CPUのみ利用 | 16 | 0 | 320 | 1.4 | 0.5 |  
...
| -v USE_SSH=*num* | ジョブ実行中の計算ノードにアクセスできるユーザを限定します。(0：自分含むグループ全員アクセスできません 1：自分のアカウントのみアクセス可能 2：グループでアクセス可能）|
