...
[root@es1 nccl]# make PREFIX=/apps/nccl/1.3.5/cuda8.0 install
```
...
[root@es1 nccl]# make PREFIX=/apps/nccl/1.3.5/cuda9.0 install
```
...
[root@es1 nccl]# make PREFIX=/apps/nccl/1.3.5/cuda9.1 install
```
