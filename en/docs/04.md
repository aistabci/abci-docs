...
In ABCI System, a 1.6 TB NVMe storage is installed into each compute node and a 1.8 TB SATA 3.0 storage is installed into each memory intensive node. There are two ways to utilize these storages as follows:
