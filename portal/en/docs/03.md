...
!!! note
    ...
    ```  
    The number of reservable nodes displayed does not include the currently executing job. Therefore, even if number of reservable nodes is displayed, the reservation may fail.
