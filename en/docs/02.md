...
To use the ABCI system, the "Responsible Person" must apply for a "user group" from the [ABCI User Portal](https://portal.abci.ai/user/project_register_app.php) and obtain an ABCI account. See the [ABCI Portal Guide](https://docs.abci.ai/portal/en/) for more details.
