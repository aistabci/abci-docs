...
Clicl "Start using" button on the screen.
...
The screen return to ABCI groups list.
...
Click "Add CS Account for Administorator" button on the screen, and click "OK" on the dialog box.
...
#### 3.6.2.2 Delete Access Keys at Once
