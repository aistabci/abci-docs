...
To use the ABCI system, the "Responsible Person" must submit a new "ABCI application" on the [ABCI User Portal](https://portal.v3.abci.ai/ProjectApplication_01)(Sorry, Japanese only) and obtain an ABCI group and one or more ABCI accounts. See the [ABCI Portal Guide](https://docs.abci.ai/v3/portal/ja/)(Sorry, Japanese only) for more details.

!!! Note
    - An ABCI account will also be issued to the "Responsible Person".
    - The "Responsible Person" can change "User" to "User Administrator" on the [ABCI User Portal](https://portal.abci.ai/user/)(Sorry, Japanese only).
