...
* 「[計算ノード(V)利用促進プログラム](https://abci.ai/news/2023/09/01/ja_nodevpromotion.html)」の開催に伴い、変更しておりました[計算ノード(V)の各資源タイプ](job-execution.md#compute-node-v)の資源タイプ課金係数を、2024年1月9日12:00より元に戻します。
