...
Your new application is completed with the above message. A confirmation e-mail is sent to the responsible person automatically. If it has not arrived after a while, the e-mail address may be incorrect. Please contact the ABCI application reception staff at <abci-application-ml@aist.go.jp>.
