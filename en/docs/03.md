...
| Maximum reserved nodes per reservation | 32 nodes *1 |
...
!!! warning
    \*1 The maximum number of nodes that can be used for a job with a single user reservation is limited to 32 nodes.
