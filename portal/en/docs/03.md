...
!!! note
    This application allows you to request up to 250 TB of total group disk usage.  
    If you would like to use more than 251 TB, please contact <qa@abci.ai> from Responsible persons or users who are granted the user administrator authority.  
