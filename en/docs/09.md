...
[Singularity](http://singularity.lbl.gov/index.html) is available on the ABCI System.
...
The available Docker image can be refer by `show_docker_images` command.
...
Exsample) Submission of job script using Docker
