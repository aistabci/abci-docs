...
| 項目 | 計算ノード(V) 合算性能・容量 | 計算ノード(A) 合算性能・容量 |
|:--|:--|:--|
| 理論ピーク演算性能 (FP64) | 37.2 PFLOPS | 19.3 PFLOPS |
| HPLによる実効性能 | 19.88 PFLOPS[^1] | TBA |
| HPLによる電力あたりの実効性能 | 14.423 GFLOPS/Watt | TBA |
| 理論ピーク演算性能 (FP32) | 75.0 PFLOPS | 151.0 PFLOPS |
| 理論ピーク演算性能 (FP16/FP32混合精度) | 550.6 PFLOPS | 300.8 PFLOPS |
| 理論ピーク演算性能 (INT8) | 261.1 POPS | 599.0 POPS |
| メモリ合算容量 | 476 TiB | 97.5 TiB |
| メモリ合算ピークバンド幅 | 4.19 PB/s | 1.54 PB/s |
| ローカルストレージの合算容量 | 1,740 TB | 480 TB |
