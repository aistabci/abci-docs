...
* 「[計算ノード(V)利用促進プログラム](https://abci.ai/news/2023/09/01/ja_nodevpromotion.html)」の開催に伴い、2023年10月2日 12:00から2024年1月9日まで[計算ノード(V)の各資源タイプ](job-execution.md#compute-node-v)の資源タイプ課金係数を以下の通り変更しました。
