...
!!! note
    ...
    Also, the memory-intensive node service ended at 15:00 on October 1, 2023, so the previous Environment Modules for CentOS 7 are no longer available.

| ABCI Environment Modules | Installed Path                | Compute Node (V) | Compute Node (A) | 
| ------------------------ | ----------------------------- | ---------------- | ---------------- |
