...
!!! warning
     After the time that cannot cancel the reservation (21: 00 on the day before the start date), you cannot see the reservation information on the ABCI User Portal.
