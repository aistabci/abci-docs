...
| 資源タイプ名 | 説明 | 割り当てCPUコア数 | 割り当てGPU数 | メモリ (GB) | ローカルストレージ (TB) | Spot及びOn-demandのABCIポイント/1時間(※) |
|:--|:--|:--|:--|:--|:--|:--|
| rt\_HF | ノード占有 | 192 | 8 | 1920 | 14 | 7.5 |
| rt\_HG | ノード共有<br>GPU利用 | 16 | 1 | 160 | 1.4 | 1.5 |
| rt\_HC | ノード共有<br>CPUのみ利用 | 32 | 0 | 320 | 1.4 | 0.5 |  
