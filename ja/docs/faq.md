...
!!! note
    ...
    - 削除したクラウドストレージアカウントの suffix は欠番となります。例えば、1つのグループに所属している利用者が aaa00000aa.1、aaa00000aa.2 の２つのクラウドストレージアカウントを持ち、aaa00000aa.2 を削除した場合、次に作成されるクラウドストレージアカウントは aaa00000aa.3 になります。「各利用者が持つことのできるアカウントは、所属する1グループあたり最大10個まで」であるので、削除後は aaa00000aa.2 を欠番として aaa00000aa.11 まで作成可能となります。
