...
Responsible persons and users who are granted the user administrator authority can use the functions described in [User Administrator Authority](https://portal.abci.ai/docs/portal/en/03/).
