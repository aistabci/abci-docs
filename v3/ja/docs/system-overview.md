...
!!! note
    ...
    * /groups-2.0は2025年9月末で提供を終了しました。詳細は[今後のストレージサービスのお知らせ](https://abci.ai/news/2024/09/04/ja_storage_after_nov2024.html)を参照してください。

[^footnote01]: 利用者ポータルは2025年3月18日より提供を開始しております。
