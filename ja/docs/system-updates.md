...
* 「[計算ノード(V)利用促進プログラム](https://abci.ai/news/2023/09/01/ja_nodevpromotion.html)」の開催に伴い、2023年10月2日 12:00から2024年1月9日まで計算ノード(V)の資源タイプ課金係数を以下の通り変更します。また、予約時の課金係数も変更後の値の1.5倍となります。なお、計算ノード(V)以外の資源タイプ課金係数については従来通りです。

| 資源タイプ | 変更前の資源タイプ課金係数 | 変更後の資源タイプ課金係数 |
|:--|:--|:--|
| rt_F       | 1.0 ポイント/時間 | 0.5 ポイント/時間 |
| rt_G.large | 0.9 ポイント/時間 | 0.5 ポイント/時間 |
| rt_G.small | 0.3 ポイント/時間 | 0.2 ポイント/時間 |
| rt_C.large | 0.6 ポイント/時間 | 0.3 ポイント/時間 |
| rt_C.small | 0.2 ポイント/時間 | 0.1 ポイント/時間 |
