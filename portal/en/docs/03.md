...
Select the ABCI group from the list of group management, and click the "Add or reduction group disk" button.
 
![[[Screenshot]]](img/3_11.png)

Enter additional disk volume and click the "Apply" button.
Select "Add" or "Reduction", enter the disk volume and click the "Apply" button.
When the dialog box is displayed, click the "OK" button.
